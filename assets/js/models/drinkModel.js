...
DrinkModel.prototype = {
    ...
    query: function (query, username, password) {
      console.log("DrinkModel.query()", query, username, password);
	...
	$.ajax({
		...
		console.log("DrinkModel.query().itemList: ", _this._itemList.length);
