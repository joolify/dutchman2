...
function CartModel() {
  ...
  /** @private */ this._commands = [];
  /** @private */ this._curCommand = null;
...
CartModel.prototype = {
  ...
  execute: function (command) {
    this._curCommand = command.execute(this._curCommand, command.value);
    this._commands.push(command);
  },
  undo: function () {
    var command = this._commands.pop();
    this._curCommand = command.undo(this._curCommand, command.value);
  },
